...
export function ProjectCard({ repo, featured }: ProjectCardProps) {
  ...
  return (
    <a
      ...
      className={`group relative rounded-xl border border-border card-bg card-shadow transition-all duration-300 hover:-translate-y-1 hover:border-primary/50 overflow-hidden cursor-pointer block ${
        featured ? "col-span-2" : ""
      }`}
    >
      {/* Glow line at top */}
      ...
      <div className="p-5">
        ...
        <div className="flex items-start justify-between gap-2 mb-3">
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            ...
            <span className="p-1.5 rounded-lg bg-secondary hover:bg-primary/20 text-muted-foreground group-hover:text-primary transition-colors" title="View on GitHub">
